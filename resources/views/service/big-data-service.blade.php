<x-service-detail-layout name="Big Data Service"
    ...
    <x-slot:solutions>
        <x-service-solution :src="asset('assets/images/services/big-data-services/data-warehouse.png')" title="Data Warehousing"
        ...
        <x-service-solution :src="asset('assets/images/services/big-data-services/predict.png')" title="Predictive Analytics"
        ...
        <x-service-solution :src="asset('assets/images/services/big-data-services/realtime.png')" title="Real-time Data Processing"
        ...
        <x-service-solution :src="asset('assets/images/services/big-data-services/segmentation.png')" title="Customer Segmentation"
        ...
        <x-service-solution :src="asset('assets/images/services/big-data-services/fraud.png')" title="Fraud Detection and Prevention"
        ...
        <x-service-solution :src="asset('assets/images/services/big-data-services/financial.png')" title="Financial Analytics"
    ...
    <x-slot:faqs>
        <x-item-faq question="Apa manfaat Layanan Big Data bagi bisnis saya?"
            answer="Layanan Big Data membantu bisnis memanfaatkan potensi data mereka secara maksimal, mendukung pengambilan keputusan yang tepat, meningkatkan pengalaman pelanggan, dan mendorong inovasi di berbagai sektor industri." />
        <x-item-faq question="Layanan spesifik apa yang Anda tawarkan di bawah Layanan Big Data?"
            answer="Layanan Big Data kami mencakup Integrasi Data, Analisis Big Data, Pergudangan Data, Visualisasi Data, Pemrosesan Data Real-time, Keamanan Big Data, Konsultasi Hadoop, Pembelajaran Mesin dan Integrasi AI, Solusi Berbasis Cloud, serta Tata Kelola dan Kualitas Data." />
        <x-item-faq question="Industri apa yang Anda layani dengan Layanan Big Data Anda?"
            answer="Solusi Big Data kami dapat diterapkan di berbagai industri, termasuk keuangan, layanan kesehatan, e-commerce, manufaktur, dan banyak lagi. Layanan kami dapat disesuaikan untuk mengatasi tantangan dan mencapai tujuan spesifik dalam berbagai sektor." />
        <x-item-faq question="Bagaimana cara memulai Layanan Big Data Anda?"
            answer="Memulainya mudah! Hubungi tim kami melalui halaman kontak atau jadwalkan konsultasi. Kami akan meninjau kebutuhan Anda, mengevaluasi lanskap data Anda, dan menawarkan solusi yang disesuaikan untuk mencapai tujuan bisnis Anda." />
    </x-slot:faqs>
